...
{
	enum {
		WEIGHT_MUN = 8,						// 가중치 계산할 개수
	};
	FLOAT					m_dispersion_sq;// 분산의 평방근
	FLOAT					m_tbl[WEIGHT_MUN];// 가중치 배열
	VOID		UpdateWeight( FLOAT param );// 가중치 배열 계산
	...
	LPDIRECT3DTEXTURE9		m_pXMap;		// 텍스처
	LPDIRECT3DSURFACE9		m_pXMapSurf;	// 표면
	LPDIRECT3DTEXTURE9		m_pXYMap;		// 텍스처
	LPDIRECT3DSURFACE9		m_pXYMapSurf;	// 표면

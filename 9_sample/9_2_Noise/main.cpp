...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
	...
	m_pMesh->UseMeshMaterials(false);// 텍스처는 직접 처리
    
	// 난수 텍스처 읽기
	if(FAILED(hr=D3DXCreateTextureFromFile( m_pd3dDevice, "random.bmp", &m_pTex)))
